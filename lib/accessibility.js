...
(function() {
  ...
  const KeyboardShortcuts = {
    ...
    addHelpButton: function() {
      ...
      button.style.cssText = `
        ...
        background: var(--color-bg-secondary, #171a1d);
        color: var(--color-text-secondary, #b2b8bf);
        border: 1px solid var(--color-border-strong, #737d87);
        font-size: 20px;
        cursor: pointer;
      ...
      button.addEventListener('mouseenter', () => {
        button.style.color = 'var(--color-focus, #ffbc52)';
      });
      button.addEventListener('mouseleave', () => {
        button.style.color = '';
      });
      
      const header = document.querySelector('.site-masthead') || document.body;
      ...
      modal.innerHTML = `
        ...
        <div class="keyboard-help-content">
          <div class="keyboard-help-header">
            <h2 id="keyboard-help-title"><iconify-icon icon="solar:keyboard-bold" width="20" height="20"></iconify-icon> Keyboard Shortcuts</h2>
  ...
  const FocusManager = {
    ...
    FOCUS_OUTLINE_COLOR: 'var(--color-focus, #ffbc52)',
    ...
    addSkipLink: function() {
      ...
      skipLink.style.cssText = `
        ...
        top: -40px;
        left: 0;
        background: var(--color-focus, #ffbc52);
        color: var(--color-text-inverse, #101214);
        padding: 8px 16px;
      ...
      if (!document.getElementById('main-content') && appContainer && !appContainer.id) {
  ...
  modalStyles.textContent = `
    ...
    .keyboard-help-content {
      position: relative;
      background: var(--color-bg-tertiary, #1e232b);
      border: 1px solid var(--color-border-strong, #737d87);
      border-radius: var(--radius-sm, 2px);
      max-width: 500px;
      width: 90%;
    ...
    .keyboard-help-header {
      ...
      align-items: center;
      padding: 1.5rem;
      border-bottom: 1px solid var(--color-border-default, #262c36);
    }
    ...
    .keyboard-help-header .close-button {
      background: none;
      border: none;
      color: var(--color-text-primary, #f3f6fa);
      font-size: 2rem;
      cursor: pointer;
      padding: 0;
      width: 44px;
    ...
    .shortcut-item kbd {
      ...
      border: 2px solid var(--color-border-default, #262c36);
      border-radius: 4px;
    ...
    .keyboard-help-footer {
      padding: 1rem 1.5rem;
      border-top: 1px solid var(--color-border-default, #262c36);
      text-align: center;
    }
