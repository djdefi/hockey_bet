...
class PWAInstall {
  ...
  showInstallBanner() {
    ...
    banner.innerHTML = `
      <div class="pwa-banner-content">
        <div class="pwa-banner-icon"><iconify-icon icon="mdi:hockey-sticks" width="32" height="32" style="color: var(--color-accent-primary, #1f9dff);"></iconify-icon></div>
  ...
  async promptInstall() {
    ...
    try {
      ...
      if (outcome === 'accepted') {
        console.debug('User accepted install prompt');
        this.trackInstallation();
      } else {
  ...
  injectStyles() {
    ...
    style.textContent = `
      ...
      .pwa-banner-subtitle {
        font-size: 0.875rem;
        color: var(--color-text-secondary, #9aa5b3);
      }
      ...
      .pwa-install-button {
        background: var(--color-accent-primary, #1f9dff);
        color: var(--color-text-inverse, #0a0c10);
        border: none;
        padding: 0.5rem 1rem;
      ...
      .pwa-dismiss-button {
        ...
        color: var(--color-text-secondary, #9aa5b3);
        border: 1px solid var(--color-border-default, #262c36);
        padding: 0.5rem 1rem;
        border-radius: 0.375rem;
        cursor: pointer;
        font-size: 0.875rem;
      ...
      .pwa-dismiss-button:hover {
        border-color: var(--color-text-secondary, #9aa5b3);
      }
