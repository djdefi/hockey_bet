  ...
  var TEAM_THEMES = {
    ...
    'default': {
      ...
      theme: {
        ...
        '--color-bg-secondary':   '#171a1d',
        '--color-bg-tertiary':    '#22262a',
        '--color-bg-hover':       '#292e33',
        '--color-accent-primary': '#ffbc52',
        '--color-accent-info':    '#87b6e5',
        '--color-border-default': '#363c42',
        '--color-border-subtle':  '#282d32',
        '--gradient-green':       'rgba(255, 188, 82, 0.08)'
      }
    },
  ...
  function applyTheme(teamKey) {
    ...
    if (meta) {
      meta.setAttribute('content',
        (teamKey && teamKey !== 'default' ? vars['--color-bg-primary'] : null) || '#101214');
    }
  }
