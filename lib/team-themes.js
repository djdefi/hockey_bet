...
(function () {
  ...
  var TEAM_THEMES = {
    ...
    'default': {
      ...
      theme: {
        ...
        '--color-bg-secondary':   '#14171d',
        '--color-bg-tertiary':    '#1e232b',
        '--color-bg-hover':       '#232932',
        '--color-accent-primary': '#1f9dff',
        '--color-accent-info':    '#1f9dff',
        '--color-border-default': '#262c36',
        '--color-border-subtle':  'rgba(255, 255, 255, 0.06)',
        '--gradient-green':       'linear-gradient(135deg, rgba(31, 157, 255, 0.15) 0%, rgba(53, 208, 127, 0.15) 100%)'
      }
    },
  ...
  function applyTheme(teamKey) {
    ...
    root.dataset.team = (teamKey && teamKey !== 'default') ? teamKey : '';

    // Update browser chrome color
    var meta = document.querySelector('meta[name="theme-color"]');
    if (meta) {
      meta.setAttribute('content',
        (teamKey && teamKey !== 'default' ? vars['--color-bg-primary'] : null) || '#0a0c10');
    }
  }
