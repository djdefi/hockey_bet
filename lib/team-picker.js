(function() {
  ...
  style.textContent = `
    ...
    @media (max-width: 767px) {
      .team-picker-trigger-label { display: none; }
    }
    ...
    @media (prefers-reduced-motion: reduce) {
      .team-picker-backdrop, .team-picker-content, .team-picker-card {
        transition: none;
        transform: none;
      }
    }
  ...
  function buildModal() {
    ...
    var closeBtn = createEl('button', {
      ...
      innerHTML: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path d="m6 6 12 12M18 6 6 18"/></svg>'
    });
  ...
  function createTrigger() {
    ...
    triggerBtn.innerHTML = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path d="M3 6h5m5 0h8M3 18h8m5 0h5"/><circle cx="10.5" cy="6" r="2.5"/><circle cx="13.5" cy="18" r="2.5"/></svg><span class="team-picker-trigger-label">Team theme</span>';
